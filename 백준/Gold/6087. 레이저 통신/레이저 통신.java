        ...
        while (!queue.isEmpty()) {
                ...
                for (int i = 0; i < 4; i++) {
                    ...
                    /*
                     ...
                     1) case 1이 먼저 탐색을 했을 때, visited[2][4]의 값은 1이다.
                     
                     2) case 2 [2,3]에서 다음 칸인 [2,4]을 탐색할때를 생각해보자. 
                     이때 [2,3]까지 설치된 거울 개수는 1이고, visited[2][4]도 1이다.
                     if (visited[nx][ny] <= nm) continue와 같이 같은 경우를 continue 해버리면 최소경로를 스킵할 가능성이 생기는 것이다.
                     */
                    if (visited[nx][ny] < nm) {
                        continue;
                    }
